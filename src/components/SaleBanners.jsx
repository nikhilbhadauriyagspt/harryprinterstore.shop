    ...
    <section className="w-full py-6 md:py-8 bg-white font-['Heebo']">
      <div className="max-w-full mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <Link to="/shop?category=laser-printers" className="relative overflow-hidden bg-[#4F46E5] p-8 md:p-10 min-h-[260px] flex flex-col justify-center group rounded-[2rem] transition-all duration-500">
          ...
          <Link to="/shop?category=all-in-one-printers" className="relative overflow-hidden bg-[#0f172a] p-8 md:p-10 min-h-[260px] flex flex-col justify-center group rounded-[2rem] transition-all duration-500">
            ...
            <div className="relative z-10">
              <span className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 text-[#4F46E5] text-[10px] font-black uppercase tracking-[2px] rounded-md mb-4 border border-white/10">
                Multi-functional
              </span>
              <h3 className="text-2xl md:text-3xl font-black text-white leading-tight mb-4 capitalize">
              ...
              <div className="inline-flex items-center gap-2 text-[#4F46E5] font-black text-xs uppercase tracking-widest transition-all">

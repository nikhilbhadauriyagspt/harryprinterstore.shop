...
export default function ShippingPolicy() {
  return (
    ...
    >
      <p className="lead">
        This Shipping & Delivery Policy is part of our Terms and Conditions ("Terms") and should be therefore read alongside our main Terms: <Link to="/terms-and-conditions">https://printermania.shop/terms-and-conditions</Link>.
      </p>
      <p>
      ...
      <p>
        If you have questions about returns, please review our Return Policy: <Link to="/return-policy">https://printermania.shop/return-policy</Link>.
      </p>
      ...
      <div className="bg-gray-50 p-8 rounded-sm border border-[#e9e9e9] my-8 not-prose">
        <address className="not-italic text-gray-700 font-bold leading-relaxed space-y-3">
          <p className="flex items-center gap-3 text-[#1447E6] font-extrabold ">Email: info@printermania.shop</p>
